define(function(require, exports, module) {
    ...
    Dialogx.prototype = {
            ...
            'genDialogContainer': function() {
                ...
                //fixed 把dialog--close去掉，防止页面刚加载时的闪屏
                ...
                if (that.options.container.length) {
                    ...
                    //fixed 增加container是字符串情况              
                    container.innerHTML = (typeof that.options.container == 'string') ? that.options.container : that.options.container.join('');
